...
public:
	Item(){};
	Item(string main, int time, char type, string note);
	Item(const Item&);
	//~Item(){};
...
Item::Item(string main, int time, char type, string note) {
	this->main = main;
	this->time = time;
	this->type = type;
	this->note = note;
